...
-- Test driver for the multi-convert miniproject (CSV -> JSON + XML).
--
-- Spawns the solution as a subprocess, pipes the fixture stdin, captures
-- stdout, and asserts the expected substrings appear.
--
-- Default target: ch18-csv-json-xml/miniproject/solution.idr (the LEARNER stub).
-- Override with the SOLUTION env var to test the _key/ reference instead.
--
-- Run from the repo root:
--   idris2 --no-banner --exec main ch18-csv-json-xml/t/SpecConvert.idr
--   SOLUTION=ch18-csv-json-xml/miniproject/_key/solution.idr idris2 --no-banner --exec main ch18-csv-json-xml/t/SpecConvert.idr

defaultSolution : String
defaultSolution = "ch18-csv-json-xml/miniproject/solution.idr"

fixturePath : String
fixturePath = "ch18-csv-json-xml/miniproject/fixtures/input.txt"

outPath : String
outPath = "/tmp/learn_idris_ch18_convert_out.txt"
