...
-- Test driver for the buggy-calculator miniproject.
--
-- Spawns the solution as a subprocess, pipes the fixture stdin, captures
-- stdout, and asserts the expected words appear.
--
-- Default target: ch05-debugging/miniproject/solution.idr (the LEARNER stub).
-- Override with the SOLUTION env var to test the _key/ reference instead.
--
-- Run from the repo root:
--   idris2 --no-banner --exec main ch05-debugging/t/SpecBugs.idr
--   SOLUTION=ch05-debugging/miniproject/_key/solution.idr idris2 --no-banner --exec main ch05-debugging/t/SpecBugs.idr

defaultSolution : String
defaultSolution = "ch05-debugging/miniproject/solution.idr"

fixturePath : String
fixturePath = "ch05-debugging/miniproject/fixtures/input.txt"

outPath : String
outPath = "/tmp/learn_idris_ch05_bugs_out.txt"
