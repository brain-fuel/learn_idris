...
--------------------------------------------------------------------------------
--          LOCAL ADD: HTML5 semantic + inline tags missing upstream.
--          Mirrors the Tag.idr fork (constructors marked LOCAL ADD there).
--------------------------------------------------------------------------------

export %inline
abbr : List (Attribute Abbr ev) -> List (Node ev) -> Node ev
abbr = El _

export %inline
b : List (Attribute Tag.B ev) -> List (Node ev) -> Node ev
b = El _

export %inline
bdi : List (Attribute Bdi ev) -> List (Node ev) -> Node ev
bdi = El _

export %inline
bdo : List (Attribute Bdo ev) -> List (Node ev) -> Node ev
bdo = El _

export %inline
cite : List (Attribute Cite ev) -> List (Node ev) -> Node ev
cite = El _

export %inline
code : List (Attribute Code ev) -> List (Node ev) -> Node ev
code = El _

export %inline
dd : List (Attribute Dd ev) -> List (Node ev) -> Node ev
dd = El _

export %inline
dfn : List (Attribute Dfn ev) -> List (Node ev) -> Node ev
dfn = El _

export %inline
dt : List (Attribute Dt ev) -> List (Node ev) -> Node ev
dt = El _

export %inline
em : List (Attribute Em ev) -> List (Node ev) -> Node ev
em = El _

export %inline
figcaption : List (Attribute Figcaption ev) -> List (Node ev) -> Node ev
figcaption = El _

export %inline
figure : List (Attribute Figure ev) -> List (Node ev) -> Node ev
figure = El _

export %inline
hgroup : List (Attribute Hgroup ev) -> List (Node ev) -> Node ev
hgroup = El _

export %inline
i : List (Attribute Tag.I ev) -> List (Node ev) -> Node ev
i = El _

export %inline
kbd : List (Attribute Kbd ev) -> List (Node ev) -> Node ev
kbd = El _

||| `<main>`. Underscored to avoid clashing with `Main.main : IO ()`.
export %inline
main_ : List (Attribute Tag.Main ev) -> List (Node ev) -> Node ev
main_ = El _

export %inline
mark : List (Attribute Mark ev) -> List (Node ev) -> Node ev
mark = El _

export %inline
nav : List (Attribute Nav ev) -> List (Node ev) -> Node ev
nav = El _

export %inline
samp : List (Attribute Samp ev) -> List (Node ev) -> Node ev
samp = El _

export %inline
search : List (Attribute Search ev) -> List (Node ev) -> Node ev
search = El _

export %inline
small : List (Attribute Small ev) -> List (Node ev) -> Node ev
small = El _

export %inline
strong : List (Attribute Strong ev) -> List (Node ev) -> Node ev
strong = El _

export %inline
sub : List (Attribute Sub ev) -> List (Node ev) -> Node ev
sub = El _

export %inline
summary : List (Attribute Summary ev) -> List (Node ev) -> Node ev
summary = El _

export %inline
sup : List (Attribute Sup ev) -> List (Node ev) -> Node ev
sup = El _

export %inline
u : List (Attribute Tag.U ev) -> List (Node ev) -> Node ev
u = El _

export %inline
var : List (Attribute Var ev) -> List (Node ev) -> Node ev
var = El _

export %inline
wbr : List (Attribute Wbr ev) -> List (Node ev) -> Node ev
wbr = El _
