...
-- Test driver for the Score Statistics miniproject.
--
-- Spawns the solution as a subprocess, pipes the fixture stdin, captures
-- stdout, and asserts the five expected lines appear.
--
-- Default target: ch06-lists/miniproject/solution.idr (the LEARNER stub).
-- Override with the SOLUTION env var to test the _key/ reference instead.
--
-- Run from the repo root:
--   idris2 --no-banner --exec main ch06-lists/t/SpecScores.idr
--   SOLUTION=ch06-lists/miniproject/_key/solution.idr idris2 --no-banner --exec main ch06-lists/t/SpecScores.idr

defaultSolution : String
defaultSolution = "ch06-lists/miniproject/solution.idr"

fixturePath : String
fixturePath = "ch06-lists/miniproject/fixtures/input.txt"

outPath : String
outPath = "/tmp/learn_idris_ch06_scores_out.txt"
...
expected = ["count: 5", "average: 72", "min: 55", "max: 92", "passing: 4"]
