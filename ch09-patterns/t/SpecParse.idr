...
-- Test driver for the Phone-Number Scraper miniproject.
--
-- Spawns the solution as a subprocess, pipes the fixture stdin, captures
-- stdout, and asserts the expected lines appear.
--
-- Default target: ch09-patterns/miniproject/solution.idr (the LEARNER stub).
-- Override with the SOLUTION env var to test the _key/ reference instead.
--
-- Run from the repo root:
--   idris2 --no-banner --exec main ch09-patterns/t/SpecParse.idr
--   SOLUTION=ch09-patterns/miniproject/_key/solution.idr idris2 --no-banner --exec main ch09-patterns/t/SpecParse.idr

defaultSolution : String
defaultSolution = "ch09-patterns/miniproject/solution.idr"

fixturePath : String
fixturePath = "ch09-patterns/miniproject/fixtures/input.txt"

outPath : String
outPath = "/tmp/learn_idris_ch09_phone_out.txt"
...
expected = ["555-123-4567", "800-555-0199", "415-867-5309"]
