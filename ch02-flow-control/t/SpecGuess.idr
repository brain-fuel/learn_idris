...
-- Test driver for the Guess-The-Number miniproject.
--
-- Spawns the solution as a subprocess, pipes the fixture stdin, captures
-- stdout, and asserts the expected words appear.
--
-- Default target: ch02-flow-control/miniproject/solution.idr (the LEARNER stub).
-- Override with the SOLUTION env var to test the _key/ reference instead.
--
-- Run from the repo root:
--   idris2 --no-banner --exec main ch02-flow-control/t/SpecGuess.idr
--   SOLUTION=ch02-flow-control/miniproject/_key/solution.idr idris2 --no-banner --exec main ch02-flow-control/t/SpecGuess.idr

defaultSolution : String
defaultSolution = "ch02-flow-control/miniproject/solution.idr"

fixturePath : String
fixturePath = "ch02-flow-control/miniproject/fixtures/input.txt"

outPath : String
outPath = "/tmp/learn_idris_ch02_guess_out.txt"
