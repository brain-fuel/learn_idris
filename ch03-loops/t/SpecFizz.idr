...
-- Test driver for the FizzBuzz miniproject.
--
-- Spawns the solution as a subprocess, pipes the fixture stdin, captures
-- stdout, and asserts the expected words appear.
--
-- Default target: ch03-loops/miniproject/solution.idr (the LEARNER stub).
-- Override with the SOLUTION env var to test the _key/ reference instead.
--
-- Run from the repo root:
--   idris2 --no-banner --exec main ch03-loops/t/SpecFizz.idr
--   SOLUTION=ch03-loops/miniproject/_key/solution.idr idris2 --no-banner --exec main ch03-loops/t/SpecFizz.idr

defaultSolution : String
defaultSolution = "ch03-loops/miniproject/solution.idr"

fixturePath : String
fixturePath = "ch03-loops/miniproject/fixtures/input.txt"

outPath : String
outPath = "/tmp/learn_idris_ch03_fizz_out.txt"
...
expected = ["Fizz", "Buzz", "FizzBuzz", "11", "19"]
