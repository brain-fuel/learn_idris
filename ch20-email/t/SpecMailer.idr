...
-- Test driver for the dry-run mailer miniproject.
--
-- Default target: ch20-email/miniproject/solution.idr (LEARNER stub).
-- Override with the SOLUTION env var to test the _key/ reference.
--
-- Run from the repo root (the verify recipe sets IDRIS2_PACKAGE_PATH):
--   idris2 --no-banner --exec main ch20-email/t/SpecMailer.idr
--   SOLUTION=ch20-email/miniproject/_key/solution.idr idris2 --no-banner --exec main ch20-email/t/SpecMailer.idr

defaultSolution : String
defaultSolution = "ch20-email/miniproject/solution.idr"

fixturePath : String
fixturePath = "ch20-email/miniproject/fixtures/input.txt"

outPath : String
outPath = "/tmp/learn_idris_ch20_mailer_out.txt"
