...
-- Test driver for the Word-Frequency Histogram miniproject.
--
-- Spawns the solution as a subprocess, pipes the fixture stdin, captures
-- stdout, and asserts the expected lines appear.
--
-- Default target: ch08-strings/miniproject/solution.idr (the LEARNER stub).
-- Override with the SOLUTION env var to test the _key/ reference instead.
--
-- Run from the repo root:
--   idris2 --no-banner --exec main ch08-strings/t/SpecHist.idr
--   SOLUTION=ch08-strings/miniproject/_key/solution.idr idris2 --no-banner --exec main ch08-strings/t/SpecHist.idr

defaultSolution : String
defaultSolution = "ch08-strings/miniproject/solution.idr"

fixturePath : String
fixturePath = "ch08-strings/miniproject/fixtures/input.txt"

outPath : String
outPath = "/tmp/learn_idris_ch08_hist_out.txt"
...
expected = ["the: 3", "fox: 2", "brown: 1", "dog: 1", "lazy: 1", "quick: 1"]
