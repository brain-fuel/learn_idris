...
-- Test driver for the One-Line Calculator miniproject.
--
-- Spawns the solution as a subprocess, pipes the fixture stdin, captures
-- stdout, and asserts the expected words appear.
--
-- Default target: ch04-functions/miniproject/solution.idr (the LEARNER stub).
-- Override with the SOLUTION env var to test the _key/ reference instead.
--
-- Run from the repo root:
--   idris2 --no-banner --exec main ch04-functions/t/SpecCalc.idr
--   SOLUTION=ch04-functions/miniproject/_key/solution.idr idris2 --no-banner --exec main ch04-functions/t/SpecCalc.idr

defaultSolution : String
defaultSolution = "ch04-functions/miniproject/solution.idr"

fixturePath : String
fixturePath = "ch04-functions/miniproject/fixtures/input.txt"

outPath : String
outPath = "/tmp/learn_idris_ch04_calc_out.txt"
