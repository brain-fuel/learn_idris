...
-- Test driver for the gsheet-append --dry-run miniproject.
--
-- Spawns the solution as a subprocess, pipes the fixture stdin,
-- captures stdout, and asserts the expected substrings appear.
--
-- Default target: ch15-google-sheets/miniproject/solution.idr (stub).
-- Override with the SOLUTION env var to test the _key/ reference instead.
--
-- Run from the repo root:
--   idris2 --no-banner --exec main ch15-google-sheets/t/SpecGSheets.idr
--   SOLUTION=ch15-google-sheets/miniproject/_key/solution.idr \
--     idris2 --no-banner --exec main ch15-google-sheets/t/SpecGSheets.idr

defaultSolution : String
defaultSolution = "ch15-google-sheets/miniproject/solution.idr"

fixturePath : String
fixturePath = "ch15-google-sheets/miniproject/fixtures/input.txt"

outPath : String
outPath = "/tmp/learn_idris_ch15_gsheets_out.txt"
...
expected = ["PUT", "values", "Sheet1!A1", "Bearer"]
